...
public class MonoHandler extends Activity {
	
	private static final String TAG = MonoHandler.class.getSimpleName();
	...
	public MonoHandler(CheckBox cb, SeekBar sb1, SeekBar sb2) {
		blinkCheckBox = cb;
		seekBar1 = sb1;
		seekBar2 = sb2;
